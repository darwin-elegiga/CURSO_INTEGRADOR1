...
let p2: Paciente = new Paciente("ALejandro","elegiga","0210068265","Palma Soriano",true,1,4,19);
let p3: Paciente = new Paciente("Saiz","elegiga","0210068265","Palma Soriano",false,1,4,24);

let p4: Paciente = new Paciente("Ricardo","elegiga","0210068265","Palma Soriano",false,2,3,60);
let p5: Paciente = new Paciente("Roberto","elegiga","0210068265","Palma Soriano",false,2,3,70);
let p6: Paciente = new Paciente("Raul","elegiga","0210068265","Palma Soriano",false,2,3,14);

let p7: Paciente = new Paciente("Fernando","elegiga","0210068265","Palma Soriano",true,3,2,19);
let p8: Paciente = new Paciente("Zambia","elegiga","0210068265","Palma Soriano",false,3,2,20);
let p9: Paciente = new Paciente("Reinier","elegiga","0210068265","Palma Soriano",true,3,2,21);

let p10: Paciente = new Paciente("Luis","elegiga","0210068265","Palma Soriano",true,4,1,40);
let p11: Paciente = new Paciente("Andres","elegiga","0210068265","Palma Soriano",true,4,1,50);
let p12: Paciente = new Paciente("Salvador","elegiga","0210068265","Palma Soriano",true,4,1,33);
